...
::: {.callout-tip}
## API Reference
See the complete vector implementation in [API Reference → Vec2](../reference/api.qmd#vec2).
:::
...
- **Vector addition**: Combines positions or velocities ([API Reference](../reference/api.qmd#vec2))
