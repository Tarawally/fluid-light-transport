...
<div class="simulation-wrapper">
    ...
    <div id="ui" style="top: 20px;"> <!-- Reset top since there is no navbar -->
      <div class="header">
      ...
      <div class="stat-row" style="margin-top: 10px;">
        ...
        <span class="value">assets/scene.json</span>
      </div>
    ...
    <canvas id="canvas" style="margin-top: 0; height: 100vh;" tabindex="0"></canvas>
</div>
